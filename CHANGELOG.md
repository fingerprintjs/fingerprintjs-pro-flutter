...
- Migrate release automation to Changesets. ([52cd626](https://github.com/fingerprintjs/fingerprintjs-pro-flutter/commit/52cd626742045d609f6ccc445eda97676721021d))
...
- use Fingerprint Pro Android v2.17.0 ([4dbaaa1](https://github.com/fingerprintjs/fingerprintjs-pro-flutter/commit/4dbaaa12f139634b1c847524d6063425b0fd01e3))
- use Fingerprint Pro iOS v2.17.0 ([851e88f](https://github.com/fingerprintjs/fingerprintjs-pro-flutter/commit/851e88fdee192e5532cca38d03fb957af29d4f26))
...
- use Fingerprint Pro Android v2.16.0 ([2130fa6](https://github.com/fingerprintjs/fingerprintjs-pro-flutter/commit/2130fa6437cfd2a99156113e48782f8eb8408905))
- use Fingerprint Pro iOS v2.16.0 ([e9aefce](https://github.com/fingerprintjs/fingerprintjs-pro-flutter/commit/e9aefcefadd01aaaa2697d01d9f44b8ac9b48224))

### Supported Native SDK Version Range

- Fingerprint Android SDK Version Range: **`>= 2.16.0 and < 2.17.0`**
- Fingerprint iOS SDK Version Range: **`>= 2.16.0 and < 2.17.0`**

## [4.9.0](https://github.com/fingerprintjs/fingerprintjs-pro-flutter/compare/v4.8.0...v4.9.0) (2026-05-05)

### Features

- use Fingerprint Pro iOS v2.15.0 ([a6891c8](https://github.com/fingerprintjs/fingerprintjs-pro-flutter/commit/a6891c8bc768ffd754c9160165da4ee203cb9c77))

### Supported Native SDK Version Range

- Fingerprint Android SDK Version Range: **`>= 2.15.0 and < 2.16.0`**
- Fingerprint iOS SDK Version Range: **`>= 2.15.0 and < 2.16.0`**

## [4.8.0](https://github.com/fingerprintjs/fingerprintjs-pro-flutter/compare/v4.7.0...v4.8.0) (2026-04-28)

### Features

- use Fingerprint Pro Android v2.15.0 ([71efe6d](https://github.com/fingerprintjs/fingerprintjs-pro-flutter/commit/71efe6da56193f828432133bb1cdd659cc5260d9))

### Supported Native SDK Version Range

- Fingerprint Android SDK Version Range: **`>= 2.15.0 and < 2.16.0`**
- Fingerprint iOS SDK Version Range: **`>= 2.14.0 and < 2.15.0`**

## [4.7.0](https://github.com/fingerprintjs/fingerprintjs-pro-flutter/compare/v4.6.0...v4.7.0) (2026-03-31)

### Features

- use Fingerprint Pro Android v2.14.0 ([bb6b9b7](https://github.com/fingerprintjs/fingerprintjs-pro-flutter/commit/bb6b9b7eb7abd36ef617bf7e9f305adedd634929))
- use Fingerprint Pro iOS v2.14.0 ([5f34319](https://github.com/fingerprintjs/fingerprintjs-pro-flutter/commit/5f34319b562273a9468ab74b388b83bf0f67b1e0))
...
## [4.6.0](https://github.com/fingerprintjs/fingerprintjs-pro-flutter/compare/v4.5.0...v4.6.0) (2026-02-19)

### Features

- use Fingerprint Pro Android v2.13.0 ([f28380e](https://github.com/fingerprintjs/fingerprintjs-pro-flutter/commit/f28380e90596fa902ea308595271b08efaf35bec))
- use Fingerprint Pro iOS v2.13.0 ([1a2b6fe](https://github.com/fingerprintjs/fingerprintjs-pro-flutter/commit/1a2b6feeb1276379d75d5bbb5e25fc26d2b63b16))

### Supported Native SDK Version Range

- Fingerprint Android SDK Version Range: **`>= 2.13.1 and < 2.14.0`**
- Fingerprint iOS SDK Version Range: **`>= 2.13.0 and < 2.14.0`**

## [4.5.0](https://github.com/fingerprintjs/fingerprintjs-pro-flutter/compare/v4.4.0...v4.5.0) (2025-12-11)

### Features

- use Fingerprint Pro Android v2.12.0 ([1974c86](https://github.com/fingerprintjs/fingerprintjs-pro-flutter/commit/1974c862ecbd7ffca7f16d0821ffa8fb2aa51612))
- use Fingerprint Pro iOS v2.12.0 ([b8e4ad4](https://github.com/fingerprintjs/fingerprintjs-pro-flutter/commit/b8e4ad44a9b03f447b943db33e6cea15905f1f68))

### Supported Native SDK Version Range

- Fingerprint Android SDK Version Range: **`>= 2.12.0 and < 2.13.0`**
- Fingerprint iOS SDK Version Range: **`>= 2.12.0 and < 2.13.0`**
